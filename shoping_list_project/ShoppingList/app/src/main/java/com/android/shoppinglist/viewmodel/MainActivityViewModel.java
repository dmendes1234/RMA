...
public class MainActivityViewModel extends AndroidViewModel {
    ...
    public MainActivityViewModel(Application application) {
        ...
        appDatabase = AppDatabase.getDBinstance(getApplication().getApplicationContext()); // dohvaćanje baze koju će live data obavješćivati
    }
    ...
    public void getAllCategoryList() { // ažuriranje sučelja nakon promjena u bazi
